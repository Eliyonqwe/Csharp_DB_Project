...
namespace Csharp_DB_Project.DB
{
    ...
    public partial class ProjectEntities1 : DbContext
    {
        ...
        [DbFunction("ProjectEntities1", "searchListing")]
        public virtual IQueryable<searchListing_Result> searchListing(string search)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<searchListing_Result>("[ProjectEntities1].[searchListing](@search)", searchParameter);
        }
    
        [DbFunction("ProjectEntities1", "searchOffersForAdmin")]
        public virtual IQueryable<searchOffersForAdmin_Result> searchOffersForAdmin(string search)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<searchOffersForAdmin_Result>("[ProjectEntities1].[searchOffersForAdmin](@search)", searchParameter);
        }
    
        [DbFunction("ProjectEntities1", "searchUser")]
        public virtual IQueryable<searchUser_Result> searchUser(string search)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<searchUser_Result>("[ProjectEntities1].[searchUser](@search)", searchParameter);
        }
